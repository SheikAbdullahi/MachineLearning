...
# Defined the FrankeFunction and create_design_matrix functions
...
degree_max = 12  # Maximum degree of polynomial
n_bootstrap = 100  # Number of bootstrap samples

# Generate data
x = np.random.rand(n_observations)
y = np.random.rand(n_observations)
z = FrankeFunction(x, y) + np.random.randn(n_observations) * 0.1  # Adding noise
